...
class Sheet:
    ...
    def update_exercises(self, exercises):
        ...
        headers = ['Exercise', 'Sets', 'Ryan: Weight (kg)', 'Ryan: Reps', 'Jamie: Weight(kg)', 'Jamie: Reps', 'Notes']
        ...
        self.worksheet.format('A1:G', {'horizontalAlignment': 'CENTER'})
        self.worksheet.format('A1:G1', {'textFormat': {'bold': True}})
